          ...
          <div class="row justify-content-between">
            ...
            <div class="col-lg-6 py-0">
              ...
              <div class="input_wrapper top_label">
                <input
                  ...
                  id="user_id"
                  @input="checkIfInputIsEmpty"
                  v-model.trim="createData.user_id"
                />
            ...
            <div class="col-lg-12 py-0">
              ...
              <div class="input_wrapper top_label">
                ...
                <textarea class="form-control" id="desc" v-model.trim="createData.desc" rows="5"></textarea>
              </div>
              <!-- END:: TEXT AREA -->
            </div>
            <!-- START:: INPUT WRAPPER -->
            ...
            <div class="col-lg-6 py-0">
              ...
              <div class="input_wrapper top_label">
                ...
                <input
                  ...
                  id="password_input"
                  @input="checkIfInputIsEmpty"
                  v-model.trim="createData.password"
                />
                <button
                  type="button"
            ...
            <div class="col-lg-6 py-0">
              ...
              <div class="input_wrapper top_label">
                ...
                <input
                  ...
                  @input="checkIfInputIsEmpty"
                  v-model.trim="createData.password_confirmation"
                />
                <button
                  type="button"
                  class="toggle_pass_btn"
...
export default {
  ...
  methods: {
    ...
    validateCreateForm() {
      ...
      if (!this.createData.avatar?.img_src) {
        this.$iziToast.error({
          timeout: 2000,
        ...
        this.btnIsLoading = false;
        return;
      } else if (!this.createData.user_id) {
        this.$iziToast.error({
          timeout: 2000,
        ...
        this.btnIsLoading = false;
        return;
      } else if (!this.createData.password) {
        this.$iziToast.error({
          timeout: 2000,
        ...
        this.btnIsLoading = false;
        return;
      } else if (this.createData.password.length < 6) {
        this.$iziToast.error({
          timeout: 2000,
        ...
        this.btnIsLoading = false;
        return;
      } else if (!this.createData.password_confirmation) {
        this.$iziToast.error({
          timeout: 2000,
        ...
        this.btnIsLoading = false;
        return;
      } else if (this.createData.password != this.createData.password_confirmation) {
        this.$iziToast.error({
          timeout: 2000,
