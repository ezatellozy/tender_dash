          ...
          <div class="col-lg-6 py-0">
            <div class="input_wrapper top_label">
              <input
                ...
                id="name_input"
                @input="checkIfInputIsEmpty"
                v-model.trim="updateData.sms_provider"
              />
          ...
          <div class="col-lg-6 py-0">
            <div class="input_wrapper top_label">
              <input
                ...
                id="name_input"
                @input="checkIfInputIsEmpty"
                v-model.trim="updateData.use_sms_service"
              />
  ...
  methods: {
    ...
    getData() {
      ...
      this.$axios({
        ...
        this.updateData.sms_sender_name = allData.sms_sender_name;
        this.updateData.sms_password = allData.sms_password;
        this.updateData.sms_username = allData.sms_username;
        this.updateData.sms_provider = allData.sms_provider;
        this.updateData.use_sms_service = allData.use_sms_service;
        this.loading = false;
      });
    },
    //END:: GET DATA
    ...
    validateCreateForm() {
      ...
      data.append("sms_sender_name", this.updateData.sms_sender_name);
      data.append("sms_password", this.updateData.sms_password);
      data.append("sms_username", this.updateData.sms_username);
      data.append("sms_provider", this.updateData.sms_provider);
      data.append("use_sms_service", this.updateData.use_sms_service);
      ...
      this.$axios({
        ...
        .then(() => {
          ...
          this.$router.push({ path: "/settings/sms" });
        })
        .catch((err) => {
          this.$iziToast.error({
            timeout: 2000,
