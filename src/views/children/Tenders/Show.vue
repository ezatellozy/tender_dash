    ...
    <div v-else>
      <div v-if="allData">
        ...
        <div class="row order-details-page">
          <h2 class="title mb-2">تفاصيل المزاد</h2>
          ...
          <div class="col-md-6 mb-3">
            <div class="single_slider">
              <div class="slider_for">
                ...
                >
                  <div v-for="media in allData.tender_images" :key="media.id">
                    ...
                    <div class="customer">
                      <div class="item">
                        ...
                        <div class="info">
                          ...
                          <p>
                            {{ allData.tender_specifications_value }}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <v-expansion-panel>
                      ...
                      <v-expansion-panel-content>
                        <div class="specfication_card">
                          <embed
                            type="video/webm"
                            :src="allData.tender_specifications_file.media"
                            width="100%"
          ...
          <div class="col-12" v-if="allData.tender_other_files.length">
            <div class="product_details">
              <h4 class="title">ملفات اخري</h4>
              <div class="row">
                <div
                  class="col-4"
                  v-for="(file, index) in allData.tender_other_files"
                  :key="index"
                >
                  <embed
                    type="video/webm"
...
export default {
  ...
  methods: {
    changeStatus(currStatus) {
      ...
      this.$axios({
        method: 'POST',
        url: `tender/${this.allData.id}/change_status`,
        data: submit_data,
      })
        .then(() => {
