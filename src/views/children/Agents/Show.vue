      ...
      <div v-if="allData">
        <div class="order-details-page mb-5 row">
          <div class="order-status">
            <h2 class="title">حالة الوكيل / الموزع</h2>
            <div class="status">
              <div class="date">
                <h5>
                  <span
        ...
        <div class="row order-details-page">
          <h2 class="title mb-2">تفاصيل الوكيل / الموزع</h2>

          <div class="col-md-6 mb-3" v-if="allData.agent_images.length">
            <div class="single_slider">
              <div class="slider_for">
                ...
                >
                  <div v-for="media in allData.agent_images" :key="media.id">
                    <img :src="media.media" v-if="media.media" />
                  </div>
                </vue-slick>
              </div>
          ...
          <div
            class="mb-3"
            :class="allData.agent_images.length ? 'col-md-6' : 'col-12'"
          >
                    ...
                    <div class="customer">
                      <div class="item">
                        ...
                        <div class="info">
                          ...
                          <p>
                            {{ allData.type_type == 'agent' ? 'وكيل' : 'موزع' }}
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="item">
                        ...
                        <div class="info">
                          ...
                          <p>
                            {{
                              allData.type ==
                              'potential_agent_or_potential_distrebutor'
                    ...
                    <v-expansion-panel>
                      ...
                      <v-expansion-panel-content>
                        <div
                          ...
                          v-for="category in allData.categories"
                          :key="category.id"
                        >
                          <div class="key">
          ...
          <div class="col-12" v-if="allData.agent_files.length">
            <div class="product_details">
              <h4 class="title">ملفات اخري</h4>
              <div class="row">
                <div
                  class="col-4"
                  v-for="(file, index) in allData.agent_files"
                  :key="index"
                >
                  <embed
                    type="video/webm"
          ...
          <div class="col-12" v-if="false">
            ...
            <main>
              ...
              >
                ...
                <!-- ======================== Start Top Section ======================== -->
                <template v-slot:top>
                  <h3 class="title table-title">عروض المزاد</h3>
                  <!-- Delete dialog -->
...
export default {
  ...
  methods: {
    changeStatus(currStatus) {
      ...
      this.$axios({
        method: 'POST',
        url: `agent/${this.allData.id}/change_status`,
        data: submit_data,
      })
        .then(() => {
